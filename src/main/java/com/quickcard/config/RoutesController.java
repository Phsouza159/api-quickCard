...
public class  RoutesController {
    ...
    public final static String CARTAO_MEMORIA_PATH_ID_BLOCO = "/cartaoMemoria/{idBloco}";
    public final static String CARTAO_MEMORIA_PATH_ID_CARTAO = "/cartaoMemoria/{idCartao}";
